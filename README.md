...
|:----------------:|:------------:|:---------------:|:----------------------------------:|:--------------------------------------------:|:----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|
|   HASpot제작    |    KUHAS     | 2025.01- |           KUHAS 동아리 관리서비스(부원모집, 동방예약등 동방운영 편의기능 개발)           | 자체웹서버구축(Ubuntu) ,DB(로컬) 서버구축,<br> 배포, 웹퍼블리싱(HTML) | [(현재배포중단)웹링크](https://kuhas.korea.ac.kr/haspot/)<br> [<img src="https://img.shields.io/badge/github-181717?style=for-the-badge&logo=github&logoColor=lightred"/>](https://github.com/KuhasSoftworks/HASpot-Project-V1)<br> (깃헙미공개) |
...
|:-----------------------------------------------:|:-----------------:|:-----------------:|:-------------------------------------------------------------------------:|:---------------------------------:|
| KUHAS (Korea University Hardward And Software)  |    SW Manager     | 2019.03 ~ 2024.08 |                      C언어 멘토링, Python 멘토링, Django Web                      |             C, Python, Java, SpringBoot             |
